...
import com.movie.lk.movie.ADetailActivity;
import com.movie.lk.movie.BaseRecyclerViewAdapter;
...
import static com.movie.lk.movie.Bean.MovieBean.*;
 ...
 */
public class MovieOnAdapter extends BaseRecyclerViewAdapter<SubjectsBean> {
    public MovieOnAdapter(Context context, List<SubjectsBean> list) {
        super(context, list);
    }
